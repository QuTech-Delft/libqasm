 ...
 *   Add [ label="Add" URL="\ref cqasm::v3::ast::Add"];
 *   Annotated [ label="Annotated" URL="\ref cqasm::v3::ast::Annotated", style=dotted];
 *   AnnotationData [ label="AnnotationData" URL="\ref cqasm::v3::ast::AnnotationData"];
 *   ArithOp [ label="ArithOp" URL="\ref cqasm::v3::ast::ArithOp", style=dotted];
 *   Assignment [ label="Assignment" URL="\ref cqasm::v3::ast::Assignment"];
 *   BinaryOp [ label="BinaryOp" URL="\ref cqasm::v3::ast::BinaryOp", style=dotted];
 *   BitwiseAnd [ label="BitwiseAnd" URL="\ref cqasm::v3::ast::BitwiseAnd"];
 *   BitwiseNot [ label="BitwiseNot" URL="\ref cqasm::v3::ast::BitwiseNot"];
 *   BitwiseOp [ label="BitwiseOp" URL="\ref cqasm::v3::ast::BitwiseOp", style=dotted];
 *   BitwiseOr [ label="BitwiseOr" URL="\ref cqasm::v3::ast::BitwiseOr"];
 *   BitwiseXor [ label="BitwiseXor" URL="\ref cqasm::v3::ast::BitwiseXor"];
 *   BreakStatement [ label="BreakStatement" URL="\ref cqasm::v3::ast::BreakStatement"];
 *   Bundle [ label="Bundle" URL="\ref cqasm::v3::ast::Bundle"];
 *   CmpEq [ label="CmpEq" URL="\ref cqasm::v3::ast::CmpEq"];
 *   CmpGe [ label="CmpGe" URL="\ref cqasm::v3::ast::CmpGe"];
 *   CmpGt [ label="CmpGt" URL="\ref cqasm::v3::ast::CmpGt"];
 *   CmpLe [ label="CmpLe" URL="\ref cqasm::v3::ast::CmpLe"];
 *   CmpLt [ label="CmpLt" URL="\ref cqasm::v3::ast::CmpLt"];
 *   CmpNe [ label="CmpNe" URL="\ref cqasm::v3::ast::CmpNe"];
 *   CmpOp [ label="CmpOp" URL="\ref cqasm::v3::ast::CmpOp", style=dotted];
 *   ContinueStatement [ label="ContinueStatement" URL="\ref cqasm::v3::ast::ContinueStatement"];
 *   Divide [ label="Divide" URL="\ref cqasm::v3::ast::Divide"];
 *   ErroneousExpression [ label="ErroneousExpression" URL="\ref cqasm::v3::ast::ErroneousExpression"];
 *   ErroneousProgram [ label="ErroneousProgram" URL="\ref cqasm::v3::ast::ErroneousProgram"];
 *   ErroneousStatement [ label="ErroneousStatement" URL="\ref cqasm::v3::ast::ErroneousStatement"];
 *   Expression [ label="Expression" URL="\ref cqasm::v3::ast::Expression", style=dotted];
 *   ExpressionList [ label="ExpressionList" URL="\ref cqasm::v3::ast::ExpressionList"];
 *   FloatLiteral [ label="FloatLiteral" URL="\ref cqasm::v3::ast::FloatLiteral"];
 *   ForLoop [ label="ForLoop" URL="\ref cqasm::v3::ast::ForLoop"];
 *   ForeachLoop [ label="ForeachLoop" URL="\ref cqasm::v3::ast::ForeachLoop"];
 *   FunctionCall [ label="FunctionCall" URL="\ref cqasm::v3::ast::FunctionCall"];
 *   Identifier [ label="Identifier" URL="\ref cqasm::v3::ast::Identifier"];
 *   IfElse [ label="IfElse" URL="\ref cqasm::v3::ast::IfElse"];
 *   IfElseBranch [ label="IfElseBranch" URL="\ref cqasm::v3::ast::IfElseBranch"];
 *   Index [ label="Index" URL="\ref cqasm::v3::ast::Index"];
 *   IndexEntry [ label="IndexEntry" URL="\ref cqasm::v3::ast::IndexEntry", style=dotted];
 *   IndexItem [ label="IndexItem" URL="\ref cqasm::v3::ast::IndexItem"];
 *   IndexList [ label="IndexList" URL="\ref cqasm::v3::ast::IndexList"];
 *   IndexRange [ label="IndexRange" URL="\ref cqasm::v3::ast::IndexRange"];
 *   Instruction [ label="Instruction" URL="\ref cqasm::v3::ast::Instruction"];
 *   IntDivide [ label="IntDivide" URL="\ref cqasm::v3::ast::IntDivide"];
 *   IntegerLiteral [ label="IntegerLiteral" URL="\ref cqasm::v3::ast::IntegerLiteral"];
 *   JsonLiteral [ label="JsonLiteral" URL="\ref cqasm::v3::ast::JsonLiteral"];
 *   LogicalAnd [ label="LogicalAnd" URL="\ref cqasm::v3::ast::LogicalAnd"];
 *   LogicalNot [ label="LogicalNot" URL="\ref cqasm::v3::ast::LogicalNot"];
 *   LogicalOp [ label="LogicalOp" URL="\ref cqasm::v3::ast::LogicalOp", style=dotted];
 *   LogicalOr [ label="LogicalOr" URL="\ref cqasm::v3::ast::LogicalOr"];
 *   LogicalXor [ label="LogicalXor" URL="\ref cqasm::v3::ast::LogicalXor"];
 *   Mapping [ label="Mapping" URL="\ref cqasm::v3::ast::Mapping"];
 *   MatrixLiteral [ label="MatrixLiteral" URL="\ref cqasm::v3::ast::MatrixLiteral"];
 *   Modulo [ label="Modulo" URL="\ref cqasm::v3::ast::Modulo"];
 *   Multiply [ label="Multiply" URL="\ref cqasm::v3::ast::Multiply"];
 *   Negate [ label="Negate" URL="\ref cqasm::v3::ast::Negate"];
 *   Power [ label="Power" URL="\ref cqasm::v3::ast::Power"];
 *   Program [ label="Program" URL="\ref cqasm::v3::ast::Program"];
 *   RepeatUntilLoop [ label="RepeatUntilLoop" URL="\ref cqasm::v3::ast::RepeatUntilLoop"];
 *   Root [ label="Root" URL="\ref cqasm::v3::ast::Root", style=dotted];
 *   ShiftLeft [ label="ShiftLeft" URL="\ref cqasm::v3::ast::ShiftLeft"];
 *   ShiftOp [ label="ShiftOp" URL="\ref cqasm::v3::ast::ShiftOp", style=dotted];
 *   ShiftRightArith [ label="ShiftRightArith" URL="\ref cqasm::v3::ast::ShiftRightArith"];
 *   ShiftRightLogic [ label="ShiftRightLogic" URL="\ref cqasm::v3::ast::ShiftRightLogic"];
 *   Statement [ label="Statement" URL="\ref cqasm::v3::ast::Statement", style=dotted];
 *   StatementList [ label="StatementList" URL="\ref cqasm::v3::ast::StatementList"];
 *   StringLiteral [ label="StringLiteral" URL="\ref cqasm::v3::ast::StringLiteral"];
 *   Structured [ label="Structured" URL="\ref cqasm::v3::ast::Structured", style=dotted];
 *   Subcircuit [ label="Subcircuit" URL="\ref cqasm::v3::ast::Subcircuit"];
 *   Subtract [ label="Subtract" URL="\ref cqasm::v3::ast::Subtract"];
 *   TernaryCond [ label="TernaryCond" URL="\ref cqasm::v3::ast::TernaryCond"];
 *   UnaryOp [ label="UnaryOp" URL="\ref cqasm::v3::ast::UnaryOp", style=dotted];
 *   Variables [ label="Variables" URL="\ref cqasm::v3::ast::Variables"];
 *   Version [ label="Version" URL="\ref cqasm::v3::ast::Version"];
 *   WhileLoop [ label="WhileLoop" URL="\ref cqasm::v3::ast::WhileLoop"];
 ...
 *   prim0 [ label="primitives::Real" URL="\ref cqasm::v3::primitives::Real"];
 ...
 *   prim3 [ label="primitives::Str" URL="\ref cqasm::v3::primitives::Str"];
 ...
 *   prim5 [ label="primitives::Version" URL="\ref cqasm::v3::primitives::Version"];
...
public:
     ...
     * Constructor.
     */
    FloatLiteral(const cqasm::v3::primitives::Real &value = cqasm::v3::primitives::initialize<cqasm::v3::primitives::Real>());
...
public:
     ...
     * Constructor.
     */
    Identifier(const cqasm::v3::primitives::Str &name = cqasm::v3::primitives::initialize<cqasm::v3::primitives::Str>());
...
public:
     ...
     * Constructor.
     */
    IntegerLiteral(const cqasm::v3::primitives::Int &value = cqasm::v3::primitives::initialize<cqasm::v3::primitives::Int>());
...
public:
     ...
     * Constructor.
     */
    JsonLiteral(const cqasm::v3::primitives::Str &value = cqasm::v3::primitives::initialize<cqasm::v3::primitives::Str>());
...
public:
     ...
     * Constructor.
     */
    StringLiteral(const cqasm::v3::primitives::Str &value = cqasm::v3::primitives::initialize<cqasm::v3::primitives::Str>());
