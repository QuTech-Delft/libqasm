...
inline constexpr auto pow = [](auto base, auto exp) { return std::pow(base, exp); };
...
inline constexpr auto shl = [](primitives::Int a, primitives::Int b) { return a << b; };
constexpr auto op_shl_ii = bf_cp<values::ConstInt, values::ConstInt, shl>{};
inline constexpr auto shr = [](primitives::Int a, primitives::Int b) { return a >> b; };
...
inline constexpr auto lxor = [](primitives::Bool lhs, primitives::Bool rhs) { return !lhs ^ !rhs; };
...
inline constexpr auto tcnd = [](bool condition, auto if_true, auto if_false) { return condition ? if_true : if_false; };
