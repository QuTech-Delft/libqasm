...
class TypeBase(Node):
    ...
    def assignable(self, val):
        ...
        if not isinstance(val, cqasm.v3.primitives.Bool):
            ...
            if isinstance(val, Node):
                raise TypeError('assignable must be of type cqasm.v3.primitives.Bool')
            val = cqasm.v3.primitives.Bool(val)
        self._attr_assignable = val

    @assignable.deleter
    def assignable(self):
        self._attr_assignable = cqasm.v3.primitives.Bool()
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_assignable, 'serialize_cbor'):
            ...
            cbor['assignable'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Bool, self._attr_assignable)
...
class Axis(TypeBase):
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if hasattr(cqasm.v3.primitives.Bool, 'deserialize_cbor'):
            f_assignable = cqasm.v3.primitives.Bool.deserialize_cbor(field)
        else:
            f_assignable = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Bool, field)
...
class ComplexMatrix(TypeBase):
    ...
    def num_rows(self, val):
        ...
        if not isinstance(val, cqasm.v3.primitives.Int):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('num_rows must be of type cqasm.v3.primitives.Int')
            val = cqasm.v3.primitives.Int(val)
        self._attr_num_rows = val

    @num_rows.deleter
    def num_rows(self):
        self._attr_num_rows = cqasm.v3.primitives.Int()
    ...
    def num_cols(self, val):
        ...
        if not isinstance(val, cqasm.v3.primitives.Int):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('num_cols must be of type cqasm.v3.primitives.Int')
            val = cqasm.v3.primitives.Int(val)
        self._attr_num_cols = val

    @num_cols.deleter
    def num_cols(self):
        self._attr_num_cols = cqasm.v3.primitives.Int()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if hasattr(cqasm.v3.primitives.Int, 'deserialize_cbor'):
            f_num_rows = cqasm.v3.primitives.Int.deserialize_cbor(field)
        else:
            f_num_rows = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Int, field)
        ...
        if hasattr(cqasm.v3.primitives.Int, 'deserialize_cbor'):
            f_num_cols = cqasm.v3.primitives.Int.deserialize_cbor(field)
        else:
            f_num_cols = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Int, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_num_rows, 'serialize_cbor'):
            ...
            cbor['num_rows'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Int, self._attr_num_rows)
        ...
        if hasattr(self._attr_num_cols, 'serialize_cbor'):
            ...
            cbor['num_cols'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Int, self._attr_num_cols)
