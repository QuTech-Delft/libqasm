...
class ConstAxis(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.Axis):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Axis')
            val = cqasm.v3.primitives.Axis(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Axis()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if hasattr(cqasm.v3.primitives.Axis, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Axis.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Axis, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Axis, self._attr_value)
...
class ConstBool(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.Bool):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Bool')
            val = cqasm.v3.primitives.Bool(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Bool()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if not isinstance(field, dict):
            raise ValueError('missing or invalid serialization of field value')
        if hasattr(cqasm.v3.primitives.Bool, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Bool.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Bool, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Bool, self._attr_value)
...
class ConstComplex(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.Complex):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Complex')
            val = cqasm.v3.primitives.Complex(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Complex()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if not isinstance(field, dict):
            raise ValueError('missing or invalid serialization of field value')
        if hasattr(cqasm.v3.primitives.Complex, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Complex.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Complex, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Complex, self._attr_value)
...
class ConstComplexMatrix(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.CMatrix):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.CMatrix')
            val = cqasm.v3.primitives.CMatrix(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.CMatrix()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if not isinstance(field, dict):
            raise ValueError('missing or invalid serialization of field value')
        if hasattr(cqasm.v3.primitives.CMatrix, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.CMatrix.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.CMatrix, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.CMatrix, self._attr_value)
...
class ConstInt(Constant):
    ...
    def value(self, val):
        ...
        if not isinstance(val, cqasm.v3.primitives.Int):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Int')
            val = cqasm.v3.primitives.Int(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Int()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if hasattr(cqasm.v3.primitives.Int, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Int.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Int, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Int, self._attr_value)
...
class ConstJson(Constant):
    ...
    def value(self, val):
        ...
        if not isinstance(val, cqasm.v3.primitives.Str):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Str')
            val = cqasm.v3.primitives.Str(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Str()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if hasattr(cqasm.v3.primitives.Str, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Str.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Str, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Str, self._attr_value)
...
class ConstReal(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.Real):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.Real')
            val = cqasm.v3.primitives.Real(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.Real()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if not isinstance(field, dict):
            raise ValueError('missing or invalid serialization of field value')
        if hasattr(cqasm.v3.primitives.Real, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.Real.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.Real, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.Real, self._attr_value)
...
class ConstRealMatrix(Constant):
    ...
    def value(self, val):
        if val is None:
            del self.value
            return
        if not isinstance(val, cqasm.v3.primitives.RMatrix):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('value must be of type cqasm.v3.primitives.RMatrix')
            val = cqasm.v3.primitives.RMatrix(val)
        self._attr_value = val

    @value.deleter
    def value(self):
        self._attr_value = cqasm.v3.primitives.RMatrix()
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if not isinstance(field, dict):
            raise ValueError('missing or invalid serialization of field value')
        if hasattr(cqasm.v3.primitives.RMatrix, 'deserialize_cbor'):
            f_value = cqasm.v3.primitives.RMatrix.deserialize_cbor(field)
        else:
            f_value = cqasm.v3.primitives.deserialize(cqasm.v3.primitives.RMatrix, field)
    ...
    def _serialize(self, id_map):
        ...
        if hasattr(self._attr_value, 'serialize_cbor'):
            ...
            cbor['value'] = cqasm.v3.primitives.serialize(cqasm.v3.primitives.RMatrix, self._attr_value)
...
class Function(Node):
    ...
    def return_type(self, val):
        ...
        if not isinstance(val, cqasm.v3.types.Node):
            # Try to "typecast" if this isn't an obvious mistake.
            if isinstance(val, Node):
                raise TypeError('return_type must be of type cqasm.v3.types.Node')
    ...
    def _deserialize(cbor, seq_to_ob, links):
        ...
        if field.get('@t', None) is None:
            ...
            f_return_type = cqasm.v3.types.Node._deserialize(field, seq_to_ob, links)
...
class VariableRef(Reference):
    ...
    def variable(self, val):
        if val is None:
            del self.variable
            return
        if not isinstance(val, cqasm.v3.semantic.Variable):
            raise TypeError('variable must be of type cqasm.v3.semantic.Variable')
