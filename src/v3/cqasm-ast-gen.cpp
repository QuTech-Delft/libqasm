 ...
 * Constructor.
 */
FloatLiteral::FloatLiteral(const cqasm::v3::primitives::Real &value)
 ...
 * Constructor.
 */
Identifier::Identifier(const cqasm::v3::primitives::Str &name)
 ...
 * Constructor.
 */
IntegerLiteral::IntegerLiteral(const cqasm::v3::primitives::Int &value)
    : Expression(), value(value)
{}
 ...
 * Constructor.
 */
JsonLiteral::JsonLiteral(const cqasm::v3::primitives::Str &value)
    : Expression(), value(value)
{}
 ...
 * Constructor.
 */
StringLiteral::StringLiteral(const cqasm::v3::primitives::Str &value)
    : Expression(), value(value)
{}
