...
#include "v3/cqasm-types-gen.hpp"
 ...
 * Constructor.
 */
TypeBase::TypeBase(const cqasm::v3::primitives::Bool &assignable)
 ...
 * Constructor.
 */
Axis::Axis(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
...
void Axis::serialize(
    ...
    cqasm::v3::primitives::serialize<cqasm::v3::primitives::Bool>(assignable, submap);
    submap.close();
...
std::shared_ptr<Axis> Axis::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<Axis>(
        cqasm::v3::primitives::deserialize<cqasm::v3::primitives::Bool>(map.at("assignable").as_map())
    );
 ...
 * Constructor.
 */
Bool::Bool(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
Complex::Complex(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
ComplexMatrix::ComplexMatrix(const cqasm::v3::primitives::Int &num_rows, const cqasm::v3::primitives::Int &num_cols, const cqasm::v3::primitives::Bool &assignable)
...
void ComplexMatrix::serialize(
    ...
    cqasm::v3::primitives::serialize<cqasm::v3::primitives::Int>(num_rows, submap);
    submap.close();
    submap = map.append_map("num_cols");
    cqasm::v3::primitives::serialize<cqasm::v3::primitives::Int>(num_cols, submap);
    submap.close();
...
std::shared_ptr<ComplexMatrix> ComplexMatrix::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ComplexMatrix>(
        cqasm::v3::primitives::deserialize<cqasm::v3::primitives::Int>(map.at("num_rows").as_map()),
        cqasm::v3::primitives::deserialize<cqasm::v3::primitives::Int>(map.at("num_cols").as_map()),
        cqasm::v3::primitives::deserialize<cqasm::v3::primitives::Bool>(map.at("assignable").as_map())
    );
    node->deserialize_annotations(map);
    return node;
 ...
 * Constructor.
 */
Int::Int(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
Json::Json(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
Qubit::Qubit(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
Real::Real(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
 ...
 * Constructor.
 */
RealMatrix::RealMatrix(const cqasm::v3::primitives::Int &num_rows, const cqasm::v3::primitives::Int &num_cols, const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable), num_rows(num_rows), num_cols(num_cols)
{}
 ...
 * Constructor.
 */
String::String(const cqasm::v3::primitives::Bool &assignable)
    : TypeBase(assignable)
{}
