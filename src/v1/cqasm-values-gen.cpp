 ...
 * Constructor.
 */
ConstAxis::ConstAxis(const cqasm::v1::primitives::Axis &value)
...
void ConstAxis::serialize(
    ...
    cqasm::v1::primitives::serialize<cqasm::v1::primitives::Axis>(value, submap);
    submap.close();
    serialize_annotations(map);
}
...
std::shared_ptr<ConstAxis> ConstAxis::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ConstAxis>(
        cqasm::v1::primitives::deserialize<cqasm::v1::primitives::Axis>(map.at("value").as_map())
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
ConstBool::ConstBool(const cqasm::v1::primitives::Bool &value)
    : Constant(), value(value)
{}
...
void ConstBool::serialize(
    ...
    auto submap = map.append_map("value");
    cqasm::v1::primitives::serialize<cqasm::v1::primitives::Bool>(value, submap);
    submap.close();
    serialize_annotations(map);
}
...
std::shared_ptr<ConstBool> ConstBool::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ConstBool>(
        cqasm::v1::primitives::deserialize<cqasm::v1::primitives::Bool>(map.at("value").as_map())
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
ConstComplex::ConstComplex(const cqasm::v1::primitives::Complex &value)
    : Constant(), value(value)
{}
...
void ConstComplex::serialize(
    ...
    auto submap = map.append_map("value");
    cqasm::v1::primitives::serialize<cqasm::v1::primitives::Complex>(value, submap);
    submap.close();
    serialize_annotations(map);
}
...
std::shared_ptr<ConstComplex> ConstComplex::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ConstComplex>(
        cqasm::v1::primitives::deserialize<cqasm::v1::primitives::Complex>(map.at("value").as_map())
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
ConstComplexMatrix::ConstComplexMatrix(const cqasm::v1::primitives::CMatrix &value)
    : Constant(), value(value)
{}
...
void ConstComplexMatrix::serialize(
    ...
    auto submap = map.append_map("value");
    cqasm::v1::primitives::serialize<cqasm::v1::primitives::CMatrix>(value, submap);
    submap.close();
    serialize_annotations(map);
}
...
std::shared_ptr<ConstComplexMatrix> ConstComplexMatrix::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ConstComplexMatrix>(
        cqasm::v1::primitives::deserialize<cqasm::v1::primitives::CMatrix>(map.at("value").as_map())
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
ConstInt::ConstInt(const cqasm::v1::primitives::Int &value)
    : Constant(), value(value)
{}
 ...
 * Constructor.
 */
ConstJson::ConstJson(const cqasm::v1::primitives::Str &value)
    : Constant(), value(value)
{}
 ...
 * Constructor.
 */
ConstReal::ConstReal(const cqasm::v1::primitives::Real &value)
    : Constant(), value(value)
{}
 ...
 * Constructor.
 */
ConstRealMatrix::ConstRealMatrix(const cqasm::v1::primitives::RMatrix &value)
    : Constant(), value(value)
{}
...
void ConstRealMatrix::serialize(
    ...
    auto submap = map.append_map("value");
    cqasm::v1::primitives::serialize<cqasm::v1::primitives::RMatrix>(value, submap);
    submap.close();
    serialize_annotations(map);
}
...
std::shared_ptr<ConstRealMatrix> ConstRealMatrix::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<ConstRealMatrix>(
        cqasm::v1::primitives::deserialize<cqasm::v1::primitives::RMatrix>(map.at("value").as_map())
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
ConstString::ConstString(const cqasm::v1::primitives::Str &value)
    : Constant(), value(value)
{}
 ...
 * Constructor.
 */
Function::Function(const cqasm::v1::primitives::Str &name, const Any<cqasm::v1::values::Node> &operands, const One<cqasm::v1::types::Node> &return_type)
...
std::shared_ptr<Function> Function::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<Function>(
        ...
        One<cqasm::v1::types::Node>(map.at("return_type").as_map(), ids)
    );
    node->deserialize_annotations(map);
    return node;
}
 ...
 * Constructor.
 */
VariableRef::VariableRef(const Link<cqasm::v1::semantic::Variable> &variable)
...
std::shared_ptr<VariableRef> VariableRef::deserialize(const ::tree::cbor::MapReader &map, ::tree::base::IdentifierMap &ids) {
    ...
    auto node = std::make_shared<VariableRef>(
        Link<cqasm::v1::semantic::Variable>(map.at("variable").as_map(), ids)
    );
...
void Dumper::visit_const_axis(ConstAxis &node) {
    ...
    if (ss.str().find('\n') == std::string::npos) {
        ...
        out << "cqasm::v1::primitives::Axis<<" << std::endl;
        indent++;
        std::string s;
        while (!ss.eof()) {
            std::getline(ss, s);
...
void Dumper::visit_const_complex(ConstComplex &node) {
    ...
    if (ss.str().find('\n') == std::string::npos) {
        ...
        out << "cqasm::v1::primitives::Complex<<" << std::endl;
        indent++;
        std::string s;
        while (!ss.eof()) {
            std::getline(ss, s);
...
void Dumper::visit_const_complex_matrix(ConstComplexMatrix &node) {
    ...
    if (ss.str().find('\n') == std::string::npos) {
        ...
        out << "cqasm::v1::primitives::CMatrix<<" << std::endl;
        indent++;
        std::string s;
        while (!ss.eof()) {
            std::getline(ss, s);
...
void Dumper::visit_const_real_matrix(ConstRealMatrix &node) {
    ...
    if (ss.str().find('\n') == std::string::npos) {
        ...
        out << "cqasm::v1::primitives::RMatrix<<" << std::endl;
        indent++;
        std::string s;
        while (!ss.eof()) {
            std::getline(ss, s);
...
void Dumper::visit_variable_ref(VariableRef &node) {
    ...
    if (node.variable.empty()) {
        ...
        out << "Link<cqasm::v1::semantic::Variable>@" << ids->get(node.variable) << std::endl;
    } else {
        out << "<" << std::endl;
        indent++;
        if (!in_link) {
