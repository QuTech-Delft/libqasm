...
%code requires {
    ...
    #include "v1.x/cqasm-ast.hpp"
    #include "v1.x/cqasm-parse-helper.hpp"
    using namespace cqasm::ast;  // for StringBuilder
    using namespace cqasm::v1x::ast;
    typedef void* yyscan_t;

    #define YYSTYPE CQASM_V1X_STYPE
    #define YYLTYPE CQASM_V1X_LTYPE

}

%code {
    int yylex(YYSTYPE* yylvalp, YYLTYPE* yyllocp, yyscan_t scanner);
    void yyerror(YYLTYPE* yyllocp, yyscan_t scanner, cqasm::v1x::parser::ParseHelper &helper, const char* msg);
}
...
%parse-param { cqasm::v1x::parser::ParseHelper &helper }
