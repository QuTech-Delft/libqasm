...
TEST(to_json, v3x_parser_errors) {
    auto input_file_path = fs::path{ "res" } / "v3x" / "tests" / "integration" / "qubit_array_definition" /
        "qubit_array_of_17" / "input.cq";
