...
TEST(tutorial, tutorial) {
    ...
    auto result = cq1x::analyze("res/v1.x/grover.cq");
    ...
    ss << clone;
    EXPECT_EQ(ss.str(),
R"(QubitRefs( # res/v1.x/grover.cq:10:9..15
  index: [
    ConstInt( # res/v1.x/grover.cq:10:11..14
      value: 0
    )
    ConstInt( # res/v1.x/grover.cq:10:11..14
      value: 1
    ...
    EXPECT_EQ(clone->get_annotation<cq1x::parser::SourceLocation>().filename, "res/v1.x/grover.cq");
