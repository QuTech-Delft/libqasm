...
TEST(tutorial, tutorial) {
    ...
    // code), and there's also cq1::analyze_string():
    ...
    // to copy (in this case) cq1::values::Node using its constructor, because
    ...
    //    through the cq1::ast namespace);
    //
    //  - the semantic tree (defined in src/cqasm-semantic.tree, available
    //    through the cq1::semantic namespace);
    //
    ...
    //    src/cqasm-types.tree, available through the cq1::types namespace).
    //
