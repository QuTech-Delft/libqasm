...
TEST(visit_function_call, analyzer_call_function_returns_a_non_empty_value) {
    const auto &function_name = std::string{ "function_that_returns_a_non_empty_value" };
...
TEST(visit_function_call, analyzer_call_function_returns_an_empty_value) {
    const auto &function_name = std::string{ "function_that_returns_an_empty_value" };
    const auto &error_message = std::string{ "function implementation returned empty value" };
    ...
    EXPECT_THAT([&]() { visitor.visit_function_call(function_call); },
        ThrowsMessage<error::AnalysisError>(::testing::HasSubstr(error_message.c_str())));
}

TEST(visit_function_call, analyzer_call_function_throws) {
