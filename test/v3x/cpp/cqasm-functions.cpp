...
TEST(op_neg_f, f_0) { EXPECT_EQ((invoke_unary<functions::op_neg_f>(0.)), 0.); }
TEST(op_neg_f, f_5) { EXPECT_EQ((invoke_unary<functions::op_neg_f>(5.)), -5.); }
TEST(op_neg_f, f_m5) { EXPECT_EQ((invoke_unary<functions::op_neg_f>(-5.)), 5.); }
...
TEST(op_add_ff, ff_m5_5) { EXPECT_EQ((invoke_binary<functions::op_add_ff>(-5., 5.)), 0.); }
TEST(op_add_ii, ii_m5_5) { EXPECT_EQ((invoke_binary<functions::op_add_ii>(-5, 5)), 0); }

TEST(op_sub_ff, ff_m5_5) { EXPECT_EQ((invoke_binary<functions::op_sub_ff>(-5., 5.)), -10.); }
TEST(op_sub_ii, ii_m5_5) { EXPECT_EQ((invoke_binary<functions::op_sub_ii>(-5, 5)), -10); }

TEST(op_mul_ff, ff_m5_5) { EXPECT_EQ((invoke_binary<functions::op_mul_ff>(-5., 5.)), -25.); }
TEST(op_mul_ii, ii_m5_5) { EXPECT_EQ((invoke_binary<functions::op_mul_ii>(-5, 5)), -25); }

TEST(op_div_ff, ff_m5_5) { EXPECT_EQ((invoke_binary<functions::op_div_ff>(-5., 5.)), -1.); }
...
TEST(op_pow_ff, f_m5_5) { EXPECT_EQ((invoke_binary<functions::op_pow_ff>(-5., 5.)), -3125.); }

TEST(op_eq_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_eq_ff>(2., 2.)), true); }
TEST(op_ne_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_ne_ff>(2., 2.)), false); }
TEST(op_ge_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_ge_ff>(2., 2.)), true); }
TEST(op_gt_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_gt_ff>(2., 2.)), false); }
TEST(op_le_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_le_ff>(2., 2.)), true); }
TEST(op_lt_ff, ff_2_2) { EXPECT_EQ((invoke_binary<functions::op_lt_ff>(2., 2.)), false); }
...
TEST(op_tcnd_bff, bff_true_m5_5) { EXPECT_EQ((invoke_ternary<functions::op_tcnd_bff>(true, -5., 5.)), -5.); }
...
TEST(fn_sqrt_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_sqrt_f>(2.)), 1.41421, 0.00001); }
TEST(fn_exp_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_exp_f>(2.)), 7.38905, 0.00001); }
TEST(fn_log_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_log_f>(2.)), 0.69314, 0.00001); }
TEST(fn_sin_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_sin_f>(2.)), 0.90929, 0.00001); }
TEST(fn_cos_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_cos_f>(2.)), -0.41614, 0.00001); }
TEST(fn_tan_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_tan_f>(2.)), -2.18503, 0.00001); }
TEST(fn_sinh_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_sinh_f>(2.)), 3.62686, 0.00001); }
TEST(fn_cosh_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_cosh_f>(2.)), 3.76219, 0.00001); }
TEST(fn_tanh_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_tanh_f>(2.)), 0.96402, 0.00001); }
TEST(fn_asin_f, f_point_2) { EXPECT_NEAR((invoke_unary<functions::fn_asin_f>(.2)), 0.20135, 0.00001); }
TEST(fn_acos_f, f_point_2) { EXPECT_NEAR((invoke_unary<functions::fn_acos_f>(.2)), 1.36943, 0.00001); }
TEST(fn_atan_f, f_point_2) { EXPECT_NEAR((invoke_unary<functions::fn_atan_f>(.2)), 0.19739, 0.00001); }
TEST(fn_asinh_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_asinh_f>(2.)), 1.44363, 0.00001); }
TEST(fn_acosh_f, f_2) { EXPECT_NEAR((invoke_unary<functions::fn_acosh_f>(2.)), 1.31695, 0.00001); }
TEST(fn_atanh_f, f_point_2) { EXPECT_NEAR((invoke_unary<functions::fn_atanh_f>(.2)), 0.20273, 0.00001); }
