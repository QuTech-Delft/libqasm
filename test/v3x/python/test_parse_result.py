...
class TestParseResult(unittest.TestCase):
    ...
    def test_to_json_with_parser_ast(self):
        ...
        expected_ast_json = '''{"Program":{"version":{"Version":{"items":"1.0","source_location":"<unknown file name>:1:9..12"}},"block":{"GlobalBlock":{"statements":[{"Variable":{"name":{"Identifier":{"name":"b"}},"typ":{"Type":{"name":{"Keyword":{"name":"bit"}},"size":{"IntegerLiteral":{"value":"0"}},"source_location":"<unknown file name>:1:14..20"}},"annotations":"[]","source_location":"<unknown file name>:1:21..22"}}]}}}}'''
