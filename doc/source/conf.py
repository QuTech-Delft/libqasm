...
latex_documents = [
    (master_doc, 'libqasm.tex', 'libqasm Documentation',
     'authors-todo', 'manual'),
]
...
man_pages = [
    (master_doc, 'libqasm', 'libqasm Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'libqasm', 'libqasm Documentation',
     author, 'libqasm', 'One line description of project.',
     'Miscellaneous'),
]
