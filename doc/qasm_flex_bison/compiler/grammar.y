...
single-qubit-operation : single-qubit-gate " " qubit-selection 
                             | prep_measure-ops " " qubit-selection
	;
single-qubit-operation-args : parameterized-single-qubit-gate " " qubit-selection ws-separator float
	;
map-operation : "map" " " qubit-selection ws-separator mapped-qubit | "map" " " bit-selection ws-separator mapped-bit
	;
...
measure : "measure" | "measure_" axis
	;
measure-parity-operation : measureparity " " qubit ws-separator axis | measure-parity-operation ws-separator qubit ws-separator axis
	;
...
binary-controlled-operations : bit-single-qubit-operation 
	...
	;
bit-single-qubit-operation : "c-" single-qubit-gate " " bit-selection ws-separator qubit-selection
	;
bit-single-qubit-operation-args : "c-" parameterized-single-qubit-gate " " bit-selection ws-separator qubit-selection ", " float
	;
